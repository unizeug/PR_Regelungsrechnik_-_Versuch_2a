...
\begin{quote}
    ...
    \begin{quote}
        Wie oben beschrieben hatten wir mit unserem Xcos-Modell Schwierigkeiten. In dieser Simulation bekommen
        wir jedoch das selbe Ergebniss wie mit dem Xcos-Modell unseres Tutors. Unser Regler hat einen
        Einzugsbereich von gerade mal $2,18^{\circ}$. Das ist nicht besonders viel und spricht für einen nicht sehr gut
        dimensioniert Regler.  Jedoch 
