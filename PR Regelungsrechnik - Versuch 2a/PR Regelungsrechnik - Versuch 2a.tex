...
\begin{quote}
    ...
    \begin{figure}[H]
        ...
        sehen sein.\\
        \TODO{Boris: es könnte doch auch keinen scnittpunkt geben oder?}
        \TODO{an Dirk: Nein, denn dann hätten wir eine Phasendrehung von 0 und der Regler wäre instabil} \\
    ...
    \begin{quote}
        ...
        \end{table} 
         \TODO{Frage an Dirk: wie zwingt man Latex die Tabelle genau dort hin zu tun wo sie im Quelltext auch steht?} \\
         
         Mit Hilfe der Sylvestermatrix und den errechneten Polen aus der Polvorgabe erechnen wir uns nun die
         Koeffizenten des äußeren Reglers.
