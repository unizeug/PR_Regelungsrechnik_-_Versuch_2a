...
\begin{quote}
    ...
    \begin{quote}
        ...
        Dazu haben wir das nichtlineare Modell in Xcos nachgearbeitet und das Sprungverhalten untersucht. Leider hat
        sich herausgestellt, dass das von uns erstellte nichtlineare Modell der Strecke fehlerhaft ist und nicht die
        erwarteten Werte ausgibt. Selbst nach langem suchen und der Hilfe unseres Tutors haben wir den Fehler nicht
        gefunden. Daher erstellen wir die in diesem Versuch benutzten Plots mit dem nichtlinearen Modell unseres
        Tutors.\vspace{1em}
        ...
        Es ist zu sehen, dass der Wagen am Anfang des Ausregelvorgangs zügig seine Geschwindigkeit ändert. Interessant
        ...
        Winkelposition von $0^{\circ}$ zu regeln. Die Position des Pendels wird noch nicht berücksichtigt. Daher ist es
        für den Regler vollkommen ausreichend das Pendel unter konstanter Geschwindigkeit bei der gewünschten
        Winkelposition zu belassen.\\
        Müsste der Regler die Geschwindikeit wieder auf $0$ drosseln müsste er das Verhalten des Pendels wieder regeln.
        Ohne einen weiteren äußeren Regler wird das nicht passieren.\vspace{1em}
        ...
        bleiben wird ist es nur logisch, dass der Wagen dadurch seine Position immer weiter von dem Ursprun entfernt.
        genau dieses Verhalten ist in der Grafik zu sehen. Theoretisch haben wir somit einen Funktionstüchtigen Regler
        entworfen. Jedoch zeit diese Grafik die Schwierigkeit des bisherigen Entwurfs. Dieser Regler würde unendlich
        viel platz benötigen. Um diese Problematik in den Griff zu kriegen werden wir noch einen äußeren Regler für die
    ...
    \begin{quote}
        Um die Störsprungantworten mit den Führungssprungantworten vergleichbar zu machen geben wir den
        selben Sprung auf das System. Jedoch nicht als Führungsgröße sondern als Störung am Ausgang des Systems. Eine konstante Ausgangsstörung unterscheidet sich in diesem fall lediglich in dem Vorzeichen von einem
        Führungssprung. Aus diesem Grund erwarten wir die selben Sprungantworten.
        ...
        Die Störsprungantworten verhalten sich genau sich wie die Führungssprungantworten und damit genauso wie wir es
        erwartet haben.
    ...
    \begin{quote}
        Die Transferfunktion vom Sollwinkel zur Wagenposition lässt sich durch das Blockschaltbild des Reglers ablesen. 
    ...
    $\frac{rad}{s}$).
    \begin{quote}
        \TODO{Empfindlichkeitsfunktion eingeben} \\
