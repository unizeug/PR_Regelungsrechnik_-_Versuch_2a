...
\begin{quote}
    ...
    \begin{quote}
        ...
        Das Führungsverhalten des äußeren Regelkreises soll dem eines dominierenden komplexen Polpaars ent- sprechen mit einer
        ungefähren Anstiegszeit von 4s und einer Dämpfung von 0,97.
        ...
        \begin{equation*}
            \begin{split}
                ...
                D &= 0.97\\
                \\
                w_0 &= \frac{1}{t_r} * exp( D/sqrt(1-D^2) * acos(D) )\\
            \end{split}
        \end{equation*}
        
        
        Da der Regler aber mehr pole
        nenner
